...
const MyProfile = () => {
    ...
    const updateUserProfileData = async () => {
        ...
        try {
            ...
            formData.append('gender', userData.gender)
            formData.append('dob', userData.dob)
            formData.append('treatmentPlan', userData.treatmentPlan) // Added treatmentPlan here
        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600'>
                    ...
                    {isEdit
                        ? <textarea className='bg-gray-50 max-w-52' onChange={(e) => setUserData(prev => ({ ...prev, treatmentPlan: e.target.value }))} value={userData.treatmentPlan} />
                        : <p className='text-gray-500'>{userData.treatmentPlan || 'No treatment plan available'}</p>
                    }
