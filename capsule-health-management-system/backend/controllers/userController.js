...
//     try {
//         const { userId, name, phone, address, dob, gender, treatmentPlan } = req.body;
...
//         // Update user profile information, including the treatment plan
...
//             dob,
//             gender,
//             treatmentPlan, // Add the treatment plan field here
//         });
...
const listAppointment = async (req, res) => {
    try {
        ...
        handleError(error, res, "Failed to list appointments.");
    }
};
...
const paymentRazorpay = async (req, res) => {
    try {
        ...
        handleError(error, res, "Payment initialization failed.");
    }
};
...
const verifyRazorpay = async (req, res) => {
    try {
        ...
        handleError(error, res, "Payment verification failed.");
    }
};
...
const paymentStripe = async (req, res) => {
    try {
        ...
        handleError(error, res, "Stripe payment failed.");
    }
};
...
const verifyStripe = async (req, res) => {
    try {
        ...
        handleError(error, res, "Stripe verification failed.");
    }
};
